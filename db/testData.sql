...
insert into customer(customerId,firstName,lastName) values ('khaled', 'khaled','gamal');
insert into customer(customerId,firstName,lastName) values ('mazen', 'mazen','abouelhassan');
insert into customer(customerId,firstName,lastName) values ('amr', 'amr','ayman');
insert into customer(customerId,firstName,lastName) values ('abdallah', 'abdallah','aloush');
